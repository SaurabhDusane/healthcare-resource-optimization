...
class DataValidator:
    ...
    def check_missing_values(self, df: pd.DataFrame, threshold: float = 0.5) -> Dict:
        ...
        if high_missing_cols:
            self.logger.warning(
                f"Columns with >{threshold*100}% missing: {high_missing_cols}"
            )
    ...
    def check_data_types(self, df: pd.DataFrame) -> Dict:
        ...
        report = {"data_types": dtypes_str, "columns_by_type": {}}
    ...
    def check_numeric_ranges(
        self, df: pd.DataFrame, expected_ranges: Dict[str, Tuple[float, float]] = None
    ) -> Dict:
        """
        ...
        report = {"outliers": {}, "range_violations": {}, "statistics": {}}
    ...
    def check_categorical_distribution(
        self, df: pd.DataFrame, min_categories: int = 2, max_categories: int = 100
    ) -> Dict:
        """
